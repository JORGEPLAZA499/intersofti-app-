...
import illustrationAsset from "@/assets/esim-onboarding-3.png.asset.json";
...
const COPY: Record<Lang, {
  ...
  es: {
    ...
    title: (
      <>
        Configura tu{" "}
        <span className="text-[#2e6b8a] font-semibold">eSIM</span> fácilmente y
        realiza un seguimiento de los{" "}
        <span className="text-[#2e6b8a] font-semibold">datos</span> y la{" "}
        <span className="text-[#2e6b8a] font-semibold">fecha de vencimiento</span>{" "}
        de tu plan.
      </>
    ),
    next: "Siguiente",
  ...
  en: {
    ...
    title: (
      <>
        Easily set up your{" "}
        <span className="text-[#2e6b8a] font-semibold">eSIM</span> and track your{" "}
        <span className="text-[#2e6b8a] font-semibold">data usage</span> and{" "}
        <span className="text-[#2e6b8a] font-semibold">plan expiry date.</span>
      </>
    ),
    next: "Next",
  },
  pt: {
    ...
    title: (
      <>
        Configure seu{" "}
        <span className="text-[#2e6b8a] font-semibold">eSIM</span> facilmente e
        acompanhe seus{" "}
        <span className="text-[#2e6b8a] font-semibold">dados</span> e a{" "}
        <span className="text-[#2e6b8a] font-semibold">data de vencimento</span>{" "}
        do seu plano.
      </>
    ),
    next: "Próximo",
    ...
    >
      ...
      <div className="mt-6 flex justify-center">
        <div className="w-14 h-14 rounded-full border-2 border-[#2e6b8a] bg-white flex items-center justify-center shadow-sm">
          <span className="text-[22px] font-semibold text-[#2e6b8a]">3</span>
        </div>
      </div>
